// Pictogramas SVG dibujados directamente (sin emojis, sin dangerouslySetInnerHTML).
// Son elementos SVG reales, así que se ven igual en cualquier navegador y computadora.
const MARKS = {
  bar: (
    <>
